...
package org.javarosa.openmrsjr.properties;
 ...
 *
 */
public class OpenMRSJRAppProperties implements IPropertyRules {
	    Hashtable rules;
	    ...
	    public final static String PATIENT_ID_PROPERTY = "preloaded-patient-id";
	    public final static String PATIENT_IDENTIFIER_PROPERTY = "preloaded-patient-identifier";
	     ...
	     */
	    public OpenMRSJRAppProperties() {
	        rules = new Hashtable();
	        readOnlyProperties = new Vector();
	        
	        rules.put(BASE_URL, new Vector());
	        rules.put(PATIENT_ID_PROPERTY, new Vector());
	        rules.put(PATIENT_IDENTIFIER_PROPERTY, new Vector());
