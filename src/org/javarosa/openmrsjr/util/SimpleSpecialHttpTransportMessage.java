...
public class SimpleSpecialHttpTransportMessage extends BasicTransportMessage {
	...
	public SimpleSpecialHttpTransportMessage() {
		//ONLY FOR SERIALIZATION
	}
	
	public SimpleSpecialHttpTransportMessage(String url) {
		this.url = url;
	 ...
	 */
	public SimpleSpecialHttpTransportMessage(String str, String url) {
	 ...
	 * @param destinationURL
	 */
	public SimpleSpecialHttpTransportMessage(byte[] str, String url) {
		content = str;
		this.url = url;
	}
	 ...
	 * @throws IOException
	 */
	public SimpleSpecialHttpTransportMessage(InputStream is, String url) throws IOException {
